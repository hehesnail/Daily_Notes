...
(TODO) python compile 调用链, HLO Passes总结

<div align="center">
<img src="https://github.com/hehesnail/Boring_code/blob/main/imgs/run_backend.png" width="100%" height="100%" /> 
</div>

上图为RunBackend对应流程，以CpuCompiler为例，主要流程对应加载MLIR方言，创建LLVM JIT对象，后针对当前HLOMoudle中HLOInstructions进行调度排序以降低内存开销，同时根据调度结果进行Buffer分配，之后针对所有的子函数即没有fuse掉的op形成的子图对应的XlaComputation生成对应的LLVM Function并添加进入emitted_functions之中。后续生成entry function对应的
...
<div align="center">
<img src="https://github.com/hehesnail/Boring_code/blob/main/imgs/while_graph.png" width="100%" height="100%" /> 
</div>
